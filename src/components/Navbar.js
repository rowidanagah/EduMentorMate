                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div  className="mt-lg-0 mt-md-3 mt-sm-3 mt-xl-0 mt-3">
                            <form className="container-fluid justify-content-end">
                                <button className="btn btn-outline-success rounded-pill me-2" type="button">Sign up</button>
                                <button className="btn btn-outline-success rounded-pill me-2" type="button">Login</button>
                            </form>
                        </div>
                    </div>
