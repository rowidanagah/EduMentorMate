  ...
  const changeData = (e) => {
    if (e.target.name == "userEmail") {
      ...
      setErrors({
        ...
        PassErr:
          e.target.value.length == 0
            ...
            ? "Error Pass is less than 8"
            : (e.target.value =
                !/^(?=.*?[A-Z])(?=(.*[a-z]){1,})(?=(.*[\d]){1,})(?=(.*[\W]){1,})(?!.*\s).{8,}$/.test(
                  e.target.value
                ) && "pass must contain contains at least one lowercase etc "),
      });
      ...
      setErrors({
        ...
        RepeatPassErr:
          e.target.value.length == 0
            ? "required Repeat pass Field"
            : e.target.value != userData.Pass && "Error Pass isnot =",
      });
      ...
      setErrors({
        ...
        UserNameErr:
          e.target.value.length == 0
            ...
            : (e.target.value =
                /\s/g.test(e.target.value) && "Error  There Was space"),
      });
    }
  };
      ...
      <div className="container">
        ...
        <div className="row d-flex">
          <div className="col-lg-4 ">
            <img
              src="https://img.freepik.com/free-vector/access-control-system-abstract-concept_335657-3180.jpg?w=740&t=st=1676318059~exp=1676318659~hmac=c4744ad235a55aeaa36a0a7e45824480f3e7f389ceaf213baacebf3b27210346"
              alt="Register image"
          ...
          <div className="col-lg-6 pl-5">
            <form className="">
              ...
              <button
                disabled={errors.PassErr || (errors.EmailErr && "disabled")}
